...
export class PreviewPane {
  ...
  private highlightSearchTerm(
    ...
    searchTerm: string,
    searchOptions:
      | { matchCase: boolean; useRegex: boolean; matchWholeWord: boolean }
      | undefined,
    ...
    try {
      ...
      console.log(
        "[PreviewPane] Finding closest match to line:",
        targetLineNumber,
      );
      ...
      console.log(
        "[PreviewPane] Closest match at line:",
        closestMatch.lineNumber,
        "distance:",
        minDistance,
      );
      ...
      console.log(
        "[PreviewPane] Highlighted HTML contains mark tags?",
  ...
  private findAllMatches(
    ...
    regex: RegExp,
  ): Array<{ node: Text; match: RegExpExecArray; lineNumber: number }> {
    const matches: Array<{
      node: Text;
  ...
  private highlightSingleMatch(matchInfo: {
    node: Text;
    match: RegExpExecArray;
    lineNumber: number;
  }): void {
